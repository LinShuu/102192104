...
function f() {
    if (!flag && choose) {
        ...
        if (color == 1) {
            switch (m) {
                case 1:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/r1.png")';
                    flag = 1;
                    break;
                case 2:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/r2.png")';
                    flag = 1;
                    break;
                case 3:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/r3.png")';
                    flag = 1;
                    break;
                case 4:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/r4.png")';
                    flag = 1;
                    break;
                case 5:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/r5.png")';
                    flag = 1;
                    break;
                case 6:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/r6.png")';
                    flag = 1;
                    break;
            }
            color = 0;
            ...
            switch (m) {
                case 1:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/b1.png")';
                    flag = 1;
                    break;
                case 2:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/b2.png")';
                    flag = 1;
                    break;
                case 3:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/b3.png")';
                    flag = 1;
                    break;
                case 4:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/b4.png")';
                    flag = 1;
                    break;
                case 5:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/b5.png")';
                    flag = 1;
                    break;
                case 6:
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tz/b6.png")';
                    flag = 1;
                    break;
            }
            color = 1;
        ...
        for (let j = 0; j < left[i].length; j++) {
            for (let k = 0; k < 3; k++) {
                if (left[i][j] == right[i][k]) {
                    ...
                    //计算对应的id值
                    m = i * 3 + k + 10;
                    document.getElementById(m).style.backgroundImage = 'url("../pictures/blank.jpg")';
                }
            }
        }
    }
...
function clearDice() {
    ...
    for (let i = 1; i < 19; i++) {
        document.getElementById(i).style.backgroundImage = 'url("../pictures/blank.jpg")';
    }
    //重置计分板
        ...
        if (left[i][j] != 0) {
            ...
            switch (m) {
                case 1:
                    ...
                    document.getElementById('ds').style.backgroundImage = 'url("../pictures/tougu.jpg")';
                    left[i][j] = m;
                    break;
                case 2:
